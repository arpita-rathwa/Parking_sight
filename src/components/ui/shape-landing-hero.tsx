...
export function HeroGeometric({
  badge = "AI Parking Intelligence",
  title1 = "ParkSight",
  title2 = "Intelligent Urban Enforcement",
}: {
  badge?: string;
  title1?: string;
  title2?: string;
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div
            ...
            animate="visible"
          >
            <h1 className="text-5xl sm:text-7xl md:text-9xl font-black mb-6 md:mb-8 tracking-tight leading-none">
              <span
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-white/90 to-purple-300 text-3xl sm:text-4xl md:text-5xl font-semibold tracking-wide block mt-2">
                {title2}
              </span>
            </h1>
          </motion.div>
